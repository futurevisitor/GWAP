...
public class orderListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		for (Iterator<OrderList> it = orderList.iterator(); it.hasNext();) {
			...
			out.println("				<td class=tablebody1 valign=middle align=center>");
			out.println("					<input type=\"button\" value=\"删除\" onclick=\"javascript:window.location='orderList.jsp';\">&nbsp;");
			out.println("					<input type=\"button\" value=\"明细\" onclick=\"javascript:window.location='orderDetail.jsp?id="+order.getOrderid()+","+order.getUserid()+","+order.getPaywayid()+"';\">");
			out.println("				</td>");
			out.println("			</tr>");
