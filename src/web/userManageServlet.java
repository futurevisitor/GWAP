...
public class userManageServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<form method=\"post\" name=\"reg\"  action=\"/toChangeManage.jsp\">");
		...
		for (Iterator<Users> it = usersList.iterator(); it.hasNext();) {
			...
			out.println("				<td class=tablebody2 valign=\"middle\" align=\"center\" height=\"25\"  width=\"35%\">");
			out.println("					");
			out.println("						<input type=\"button\" value=\"修改\" onclick=\"javascript:window.location='userModify.jsp?id="+user.getUserId()+"';\" /> ");
